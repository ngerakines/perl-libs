# This Makefile is for the WWW::Wow::RealmStatus extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/WWW/Wow/RealmStatus.pm]
#     AUTHOR => q[Nick Gerakines <nick@gerakines.net>]
#     NAME => q[WWW::Wow::RealmStatus]
#     PL_FILES => {  }
#     PREREQ_PM => { Test::More=>q[0] }
#     VERSION_FROM => q[lib/WWW/Wow/RealmStatus.pm]
#     clean => { FILES=>q[WWW-Wow-RealmStatus-*] }
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/WWW/Wow/RealmStatus.pm

# Where is the Config information that we are using/depend on
CONFIGDEP = $(PERL_ARCHLIB)$(DFSEP)Config.pm $(PERL_INC)$(DFSEP)config.h

# Where to build things
INST_LIBDIR      = $(INST_LIB)/WWW/Wow
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/WWW/Wow
...
TO_INST_PM = lib/WWW/Wow/RealmStatus.pm \
	process.pl

PM_TO_BLIB = lib/WWW/Wow/RealmStatus.pm \
	blib/lib/WWW/Wow/RealmStatus.pm \
	process.pl \
	$(INST_LIB)/WWW/Wow/process.pl
...
DISTNAME = WWW-Wow-RealmStatus
DISTVNAME = WWW-Wow-RealmStatus-0.5
...
manifypods : pure_all  \
	lib/WWW/Wow/RealmStatus.pm \
	lib/WWW/Wow/RealmStatus.pm
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/WWW/Wow/RealmStatus.pm $(INST_MAN3DIR)/WWW::Wow::RealmStatus.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'name:         WWW-Wow-RealmStatus' >> META_new.yml
	$(NOECHO) $(ECHO) 'version:      0.5' >> META_new.yml
	$(NOECHO) $(ECHO) 'version_from: lib/WWW/Wow/RealmStatus.pm' >> META_new.yml
...
ppd:
	...
	$(NOECHO) $(ECHO) '    <ABSTRACT>The great new WWW::Wow::RealmStatus!</ABSTRACT>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <AUTHOR>Nick Gerakines &lt;nick@gerakines.net&gt;</AUTHOR>' >> $(DISTNAME).ppd
...
pm_to_blib : $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', '\''$(PM_FILTER)'\'')' \
	  lib/WWW/Wow/RealmStatus.pm blib/lib/WWW/Wow/RealmStatus.pm \
	  process.pl $(INST_LIB)/WWW/Wow/process.pl 
